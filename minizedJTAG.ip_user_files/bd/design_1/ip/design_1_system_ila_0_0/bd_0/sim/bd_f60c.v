...
module bd_f60c
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK, CLK_DOMAIN design_1_processing_system7_0_0_FCLK_CLK0, FREQ_HZ 200000000, PHASE 0.000" *) input clk;
  input [15:0]probe0;
  ...
  bd_f60c_ila_lib_0 ila_lib
       (.clk(clk_1),
        .probe0(probe0_1),
        .probe1(SLOT_0_SPI_sck_i_1),
        .probe10(SLOT_0_SPI_ss_i_1),
        .probe11(SLOT_0_SPI_ss_o_1),
        .probe12(SLOT_0_SPI_ss1_o_1),
        .probe13(SLOT_0_SPI_ss2_o_1),
        .probe14(SLOT_0_SPI_ss_t_1),
        .probe2(SLOT_0_SPI_sck_o_1),
        .probe3(SLOT_0_SPI_sck_t_1),
        .probe4(SLOT_0_SPI_io0_i_1),
        .probe5(SLOT_0_SPI_io0_o_1),
        .probe6(SLOT_0_SPI_io0_t_1),
        .probe7(SLOT_0_SPI_io1_i_1),
        .probe8(SLOT_0_SPI_io1_o_1),
        .probe9(SLOT_0_SPI_io1_t_1));
endmodule

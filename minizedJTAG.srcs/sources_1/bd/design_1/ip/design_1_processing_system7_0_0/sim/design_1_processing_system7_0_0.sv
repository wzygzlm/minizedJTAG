...
//PARAMETERS
      ...
      parameter C_EMIO_GPIO_WIDTH = 16;
      ...
      parameter C_PACKAGE_NAME = "clg225";
...
//REG DECLARATIONS
      ...
      reg SDIO0_CMD_O;
      reg SDIO0_CMD_T;
      reg [3 : 0] SDIO0_DATA_O;
      reg [3 : 0] SDIO0_DATA_T;
      reg SDIO0_LED;
      reg SDIO0_BUSPOW;
      reg [2 : 0] SDIO0_BUSVOLT;
      reg UART0_DTRN;
      reg UART0_RTSN;
      reg UART0_TX;
...
//INITIAL BLOCK
  ...
  always #(500.0) FCLK_CLK0 <= ~FCLK_CLK0;
  ...
  always #(500.0) FCLK_CLK1 <= ~FCLK_CLK1;

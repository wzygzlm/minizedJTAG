...
proc create_root_design { parentCell } {
  ...
  # Create instance: minizedJTAG_0, and set properties
  set block_name minizedJTAG
  set block_cell_name minizedJTAG_0
  if { [catch {set minizedJTAG_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $minizedJTAG_0 eq "" } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_FCLK0_PERIPHERAL_DIVISOR0 {40} \
   CONFIG.PCW_FCLK0_PERIPHERAL_DIVISOR1 {35} \
   CONFIG.PCW_FCLK1_PERIPHERAL_CLKSRC {IO PLL} \
   CONFIG.PCW_FCLK1_PERIPHERAL_DIVISOR0 {40} \
   CONFIG.PCW_FCLK1_PERIPHERAL_DIVISOR1 {35} \
  ...
  connect_bd_net -net TDO_0_1 [get_bd_ports TDO_0] [get_bd_pins minizedJTAG_0/TDO]
  connect_bd_net -net minizedJTAG_0_TCK [get_bd_ports TCK_0] [get_bd_pins minizedJTAG_0/TCK]
  connect_bd_net -net minizedJTAG_0_TDI [get_bd_ports TDI_0] [get_bd_pins minizedJTAG_0/TDI]
  connect_bd_net -net minizedJTAG_0_TMS [get_bd_ports TMS_0] [get_bd_pins minizedJTAG_0/TMS]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins c_counter_binary_0/CLK] [get_bd_pins minizedJTAG_0/sysClk] [get_bd_pins processing_system7_0/FCLK_CLK1]
